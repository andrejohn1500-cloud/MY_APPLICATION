...
# Step 2: python3 /workspaces/MY_APPLICATION/batch10.py
...
SUBJECTS = [
    ("cape_management_of_business", "CAPE Management of Business", "business organisation, management functions, human resource management, marketing, finance, operations management, entrepreneurship, Caribbean business environment, strategic management, business ethics"),
    ("cape_mathematics", "CAPE Pure Mathematics", "algebra, functions, calculus, trigonometry, complex numbers, matrices, vectors, sequences and series, coordinate geometry, differential equations, mathematical proof"),
    ("cape_music", "CAPE Music", "music theory, harmony, counterpoint, Caribbean music history, music analysis, composition, orchestration, music technology, world music, music performance"),
    ("cape_physics", "CAPE Physics", "mechanics, thermal physics, waves, electricity and magnetism, atomic and nuclear physics, AC circuits, electronics, gravitational fields, medical physics, Caribbean physics applications"),
    ("cape_political_science", "CAPE Political Science", "political theory, Caribbean governance, democracy, constitutions, political parties, elections, Caribbean integration, international relations, human rights, political ideologies"),
]
...
print("\n✅ Batch 10 complete — committing...")
os.system('git add . && git commit -m "Batch 10: CAPE Management of Business, Mathematics, Music, Physics, Political Science — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
