...
# Step 2: python3 /workspaces/MY_APPLICATION/batch7.py
...
SUBJECTS = [
    ("cape_accounting", "CAPE Accounting", "financial accounting, management accounting, company accounts, cost accounting, budgeting, auditing, accounting standards, Caribbean business accounting, financial analysis, accounting ethics"),
    ("cape_agricultural_science", "CAPE Agricultural Science", "soil science, crop production, animal husbandry, agricultural economics, farm management, biotechnology in agriculture, environmental impact, Caribbean agriculture, food security, agribusiness"),
    ("cape_applied_mathematics", "CAPE Applied Mathematics", "statistics, probability, mechanics, linear programming, kinematics, dynamics, statistical inference, regression, hypothesis testing, applied calculus"),
    ("cape_biology", "CAPE Biology", "cell biology, biochemistry, genetics, evolution, ecology, physiology, plant biology, microbiology, biotechnology, Caribbean ecosystems, molecular biology"),
    ("cape_caribbean_studies", "CAPE Caribbean Studies", "Caribbean identity, colonialism, independence, Caribbean integration, CARICOM, sustainable development, Caribbean culture, diaspora, governance, Caribbean economy"),
]
...
print("\n✅ Batch 7 complete — committing...")
os.system('git add . && git commit -m "Batch 7: CAPE Accounting, Agricultural Science, Applied Mathematics, Biology, Caribbean Studies — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
