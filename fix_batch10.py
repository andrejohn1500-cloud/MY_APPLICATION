...
# Step 2: python3 /workspaces/MY_APPLICATION/fix_batch10.py
...
os.system('git add . && git commit -m "Batch 10 fix: CAPE Physics and Political Science — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
