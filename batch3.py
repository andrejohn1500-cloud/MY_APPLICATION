...
# Step 2: python3 /workspaces/MY_APPLICATION/batch3.py
...
SUBJECTS = [
    ("cxc_agricultural_science", "CXC Agricultural Science", "soil science, plant nutrition, crop production, pest management, livestock, agricultural economics, farm management, irrigation, Caribbean agriculture, food security"),
    ("cxc_biology", "CXC CSEC Biology", "cell biology, nutrition, transport, respiration, excretion, reproduction, genetics, ecology, evolution, disease, biotechnology, Caribbean biology"),
    ("cxc_building_technology", "CXC Building Technology", "building materials, construction methods, technical drawing, carpentry, masonry, plumbing, electrical installation, building regulations, health and safety, project management"),
    ("cxc_chemistry", "CXC CSEC Chemistry", "atomic structure, periodic table, chemical bonding, stoichiometry, acids bases salts, electrochemistry, organic chemistry, industrial chemistry, environmental chemistry, Caribbean chemistry"),
    ("cxc_clothing_textiles", "CXC Clothing and Textiles", "fibres and fabrics, sewing techniques, pattern making, garment construction, textile care, fashion design, clothing history, Caribbean fashion, consumer education, textile technology"),
]
...
print("\n✅ Batch 3 complete — committing...")
os.system('git add . && git commit -m "Batch 3: CXC Agricultural Science, Biology, Building Technology, Chemistry, Clothing and Textiles — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
