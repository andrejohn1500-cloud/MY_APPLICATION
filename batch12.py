...
# Step 2: python3 /workspaces/MY_APPLICATION/batch12.py
...
SUBJECTS = [
    ("cvq_agricultural_production", "CVQ Agricultural Production", "soil preparation, crop planting, pest and disease management, harvesting, post harvest handling, livestock care, farm safety, agricultural tools and equipment, Caribbean farming practices, sustainable agriculture"),
    ("cvq_carpentry_joinery", "CVQ Carpentry and Joinery", "wood types and properties, hand tools, power tools, joints and connections, furniture making, door and window frames, roofing, safety practices, blueprint reading, finishing techniques"),
    ("cvq_cosmetology", "CVQ Cosmetology", "hair care and styling, chemical treatments, skin care, nail care, salon hygiene and sanitation, cosmetology tools and equipment, client consultation, Caribbean hair types, business skills, health and safety"),
    ("cvq_early_childhood", "CVQ Early Childhood Care and Education", "child development, play and learning, health and nutrition, child protection, curriculum planning, observation and assessment, parent communication, inclusive education, Caribbean family contexts, professional ethics"),
    ("cvq_electrical_installation", "CVQ Electrical Installation", "electrical theory, wiring systems, circuit installation, safety regulations, tools and equipment, reading electrical drawings, earthing systems, lighting installation, Caribbean electrical standards, fault finding"),
]
...
print("\n✅ Batch 12 complete — committing...")
os.system('git add . && git commit -m "Batch 12: CVQ Agricultural Production, Carpentry, Cosmetology, Early Childhood, Electrical Installation — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
