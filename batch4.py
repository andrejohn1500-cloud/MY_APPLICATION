...
# Step 2: python3 /workspaces/MY_APPLICATION/batch4.py
...
SUBJECTS = [
    ("cxc_economics", "CXC CSEC Economics", "supply and demand, market structures, national income, money and banking, international trade, economic development, Caribbean economies, government fiscal policy, unemployment, inflation"),
    ("cxc_food_nutrition", "CXC Food and Nutrition", "nutrients and their functions, food groups, digestion, meal planning, food preparation, food safety and hygiene, preservation, Caribbean cuisine, diet and disease, consumer education"),
    ("cxc_french", "CXC CSEC French", "listening comprehension, reading comprehension, grammar, vocabulary, speaking, writing, French culture, everyday situations, travel, family and relationships"),
    ("cxc_history", "CXC CSEC History", "Caribbean history, slavery and emancipation, colonialism, independence movements, World War impacts on Caribbean, political development, social history, economic history, nationalism, Caribbean leaders"),
    ("cxc_human_social_biology", "CXC Human and Social Biology", "cell biology, nutrition and digestion, circulatory system, respiratory system, nervous system, reproductive system, disease and immunity, genetics, ecology, public health in the Caribbean"),
]
...
print("\n✅ Batch 4 complete — committing...")
os.system('git add . && git commit -m "Batch 4: CXC Economics, Food and Nutrition, French, History, Human and Social Biology — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
