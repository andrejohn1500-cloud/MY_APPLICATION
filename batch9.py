...
# Step 2: python3 /workspaces/MY_APPLICATION/batch9.py
...
SUBJECTS = [
    ("cape_french", "CAPE French", "French grammar, reading comprehension, writing, oral communication, French literature, Francophone Caribbean culture, French history, current affairs in French, translation, French cinema and media"),
    ("cape_geography", "CAPE Geography", "physical geography, human geography, Caribbean geography, population, development, natural hazards, climate change, geomorphology, economic geography, regional planning"),
    ("cape_history", "CAPE History", "Caribbean history, slavery, emancipation, colonialism, independence, Cold War impact on Caribbean, Caribbean political development, social history, United States Caribbean relations, regional integration history"),
    ("cape_law", "CAPE Law", "sources of law, constitutional law, criminal law, tort law, contract law, Caribbean legal systems, human rights law, family law, company law, Caribbean Court of Justice"),
    ("cape_literatures_english", "CAPE Literatures in English", "Caribbean literature, postcolonial literature, poetry analysis, prose fiction, drama, literary devices, themes, characterisation, African literature, American literature, critical theory"),
]
...
print("\n✅ Batch 9 complete — committing...")
os.system('git add . && git commit -m "Batch 9: CAPE French, Geography, History, Law, Literatures in English — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
