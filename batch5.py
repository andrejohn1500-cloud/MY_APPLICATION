...
# Step 2: python3 /workspaces/MY_APPLICATION/batch5.py
...
SUBJECTS = [
    ("cxc_music", "CXC CSEC Music", "music theory, notation, rhythm, melody, harmony, musical forms, Caribbean music, calypso, reggae, soca, steelpan, musical instruments, music history, composition, aural skills"),
    ("cxc_physics", "CXC CSEC Physics", "mechanics, forces and motion, energy, waves, light, sound, electricity, magnetism, atomic physics, thermal physics, measurements, Caribbean physics applications"),
    ("cxc_principles_of_accounts", "CXC Principles of Accounts", "bookkeeping, double entry system, ledgers, trial balance, financial statements, cash flow, depreciation, partnerships, companies, business accounts, Caribbean business accounting"),
    ("cxc_religious_education", "CXC Religious Education", "world religions, Christianity, Islam, Hinduism, African religious traditions, Caribbean religious practices, ethics and morality, religious texts, social issues and religion, spirituality"),
    ("cxc_spanish", "CXC CSEC Spanish", "listening comprehension, reading comprehension, grammar, vocabulary, speaking, writing, Hispanic culture, everyday situations, travel, family, Latin American geography and culture"),
]
...
print("\n✅ Batch 5 complete — committing...")
os.system('git add . && git commit -m "Batch 5: CXC Music, Physics, Principles of Accounts, Religious Education, Spanish — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
