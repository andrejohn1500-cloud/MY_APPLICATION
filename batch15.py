...
# Step 2: python3 /workspaces/MY_APPLICATION/batch15.py
...
SUBJECTS = [
    ("cpea_mathematics", "CPEA Mathematics", "number operations, fractions and decimals, percentages, measurement, geometry, algebra, statistics, problem solving, consumer arithmetic, patterns, sets and Venn diagrams"),
    ("cpea_english", "CPEA English Language", "reading comprehension, vocabulary, grammar, punctuation, creative writing, letter writing, summary writing, poetry appreciation, oral language, sentence structure"),
    ("cpea_science", "CPEA Science", "living things, plant and animal biology, human body, matter and materials, forces and energy, earth and environment, scientific method, Caribbean ecosystems, health and nutrition, technology and science"),
    ("cpea_social_studies", "CPEA Social Studies", "Caribbean history, family and community, citizenship, governance, Caribbean geography, culture and identity, economics, environment, human rights, Caribbean integration"),
    ("sat_math", "SAT Mathematics College Board", "algebra, advanced algebra, problem solving and data analysis, geometry, trigonometry, statistics, linear equations, quadratic equations, functions, ratios and proportions, data interpretation"),
]
...
print("\n✅ Batch 15 complete — committing...")
os.system('git add . && git commit -m "Batch 15: CPEA Mathematics, English, Science, Social Studies, SAT Math — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
