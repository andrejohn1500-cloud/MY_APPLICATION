...
<FrameLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout
        ...
        <!-- Progress bar: thicker, 70% width, centered -->
        <LinearLayout
            android:layout_width="match_parent"
            android:layout_height="wrap_content"
            android:orientation="horizontal"
        ...
        <!-- Category label: centered, bigger -->
        <TextView
        ...
        <!-- Spacer pushes question + buttons to bottom -->
        <Space
            android:layout_width="match_parent"
            android:layout_height="0dp"
            android:layout_weight="1"/>

        <!-- Question text sits just above buttons -->
        <TextView
    ...
    <!-- Scientist popup: floats above buttons, slides from right -->
