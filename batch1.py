...
SUBJECTS = [
    ("cxc_english_a", "CXC CSEC English A", "reading comprehension, grammar, writing skills, poetry, prose, literary devices, summary writing, vocabulary"),
    ("cxc_english_b", "CXC CSEC English B", "poetry analysis, prose fiction, drama, Caribbean literature, literary devices, themes, characterisation, symbolism"),
    ("cxc_mathematics", "CXC CSEC Mathematics", "number theory, algebra, geometry, trigonometry, statistics, probability, consumer arithmetic, sets, matrices, vectors"),
    ("cxc_integrated_science", "CXC CSEC Integrated Science", "biology, chemistry, physics, scientific method, ecosystems, human body, matter, energy, electricity, earth science"),
    ("cxc_social_studies", "CXC CSEC Social Studies", "Caribbean society, family, culture, governance, citizenship, economics, environment, population, crime, CARICOM"),
]
...
Rules: strictly syllabus based, no repeats, each has one correct answer and 3 wrong answers.
Do not use: {list(existing)[:3]}
...
os.system('git add . && git commit -m "Batch 1: CXC English A, English B, Mathematics, Integrated Science, Social Studies — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
