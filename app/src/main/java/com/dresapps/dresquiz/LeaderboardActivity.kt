...
class LeaderboardActivity : AppCompatActivity() {
    ...
    private fun showCategorySelector() {
        val cats = arrayOf("All","Caribbean History","Science & Tech","Sports","World Geography","Arts & Culture","SVG & Vincy Life","CXC English A","CXC English B","CXC Maths","CXC Integrated Science","CXC Social Studies","CXC Geography","CXC POB","CXC IT","CXC Office Admin","CXC Physical Education","CXC Agricultural Science","CXC Biology","CXC Building Technology","CXC Chemistry","CXC Clothing & Textiles","CXC Economics","CXC Food & Nutrition","CXC French","CXC History","CXC Human & Social Biology","CXC Music","CXC Physics","CXC Principles of Accounts","CXC Religious Education","CXC Spanish","CXC TCF","CXC Technical Drawing","CXC Theatre Arts","CXC Tourism","CXC Visual Arts","CPEA English","CPEA Maths","CPEA Science","CPEA Social Studies","SEA Maths","SEA Language Arts","PEP Ability Test","PEP Maths","PEP Language Arts","CAPE Accounting","CAPE Agricultural Science","CAPE Applied Mathematics","CAPE Biology","CAPE Caribbean Studies","CAPE Chemistry","CAPE Communication Studies","CAPE Computer Science","CAPE Economics","CAPE Environmental Science","CAPE French","CAPE Geography","CAPE History","CAPE Law","CAPE Literatures in English","CAPE Management of Business","CAPE Maths","CAPE Music","CAPE Physics","CAPE Political Science","CAPE Psychology","CAPE Sociology","CAPE Spanish","CAPE Tourism","CAPE Visual Arts","CVQ Agricultural Production","CVQ Carpentry & Joinery","CVQ Cosmetology","CVQ Early Childhood","CVQ Electrical Installation","CVQ Food Preparation","CVQ Information Technology","CVQ Motor Vehicle","CVQ Plumbing","CVQ Welding & Fabrication","SAT Math","SAT Reading & Writing")
        android.app.AlertDialog.Builder(this)
