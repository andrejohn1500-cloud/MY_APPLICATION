...
# Step 2: python3 /workspaces/MY_APPLICATION/batch8.py
...
SUBJECTS = [
    ("cape_chemistry", "CAPE Chemistry", "atomic structure, chemical bonding, energetics, kinetics, equilibrium, electrochemistry, organic chemistry, spectroscopy, industrial chemistry, environmental chemistry"),
    ("cape_communication_studies", "CAPE Communication Studies", "language and communication, oral communication, written communication, Caribbean vernacular, media literacy, critical analysis, persuasion, rhetoric, communication ethics, Caribbean identity"),
    ("cape_computer_science", "CAPE Computer Science", "programming, algorithms, data structures, object oriented programming, databases, networking, operating systems, cybersecurity, software engineering, Caribbean ICT development"),
    ("cape_economics", "CAPE Economics", "microeconomics, macroeconomics, market structures, national income, monetary policy, fiscal policy, international trade, Caribbean economic development, development economics, globalisation"),
    ("cape_environmental_science", "CAPE Environmental Science", "ecosystems, biodiversity, climate change, pollution, natural resources, environmental management, Caribbean environment, sustainable development, environmental policy, natural hazards"),
]
...
print("\n✅ Batch 8 complete — committing...")
os.system('git add . && git commit -m "Batch 8: CAPE Chemistry, Communication Studies, Computer Science, Economics, Environmental Science — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
