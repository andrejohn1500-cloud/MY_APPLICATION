...
# Step 2: python3 /workspaces/MY_APPLICATION/batch11.py
...
SUBJECTS = [
    ("cape_psychology", "CAPE Psychology", "biological psychology, cognitive psychology, developmental psychology, social psychology, abnormal psychology, research methods, Caribbean psychology, mental health, personality theories, psychological disorders"),
    ("cape_sociology", "CAPE Sociology", "sociological theory, culture and society, socialisation, social stratification, family, education, religion, deviance and crime, Caribbean society, gender, race and ethnicity, globalisation"),
    ("cape_spanish", "CAPE Spanish", "Spanish grammar, reading comprehension, writing, oral communication, Hispanic literature, Latin American culture and history, current affairs in Spanish, translation, Spanish cinema and media"),
    ("cape_tourism", "CAPE Tourism", "tourism theory, Caribbean tourism development, tourism impacts, sustainable tourism, hospitality management, tourism marketing, ecotourism, cruise tourism, heritage tourism, Caribbean tourism policy"),
    ("cape_visual_arts", "CAPE Visual Arts", "art history, Caribbean art, art theory, drawing and painting, sculpture, printmaking, art criticism, contemporary art, design principles, Caribbean artists and their works"),
]
...
print("\n✅ Batch 11 complete — committing...")
os.system('git add . && git commit -m "Batch 11: CAPE Psychology, Sociology, Spanish, Tourism, Visual Arts — 15q per level syllabus based" && git pull --rebase origin master && git push origin master')
print("✅ Done!")
